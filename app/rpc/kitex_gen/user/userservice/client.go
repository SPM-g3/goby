...
type Client interface {
	...
	Seller(ctx context.Context, req *user.SellerReq, callOptions ...callopt.Option) (r *user.SellerResp, err error)
}
...
func (p *kUserServiceClient) Seller(ctx context.Context, req *user.SellerReq, callOptions ...callopt.Option) (r *user.SellerResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Seller(ctx, req)
}
