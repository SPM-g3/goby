...
func (p *kOrderServiceClient) UpdateOrderTracking(ctx context.Context, req *order.UpdateOrderTrackingReq, callOptions ...callopt.Option) (r *order.UpdateOrderTrackingResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpdateOrderTracking(ctx, req)
}

func (p *kOrderServiceClient) UpdateOrderDiscount(ctx context.Context, req *order.UpdateOrderDiscountReq, callOptions ...callopt.Option) (r *order.UpdateOrderDiscountResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpdateOrderDiscount(ctx, req)
}
