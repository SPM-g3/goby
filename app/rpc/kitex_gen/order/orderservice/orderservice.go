...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"UpdateOrderTracking": kitex.NewMethodInfo(
		updateOrderTrackingHandler,
		newOrderServiceUpdateOrderTrackingArgs,
		newOrderServiceUpdateOrderTrackingResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"UpdateOrderDiscount": kitex.NewMethodInfo(
		updateOrderDiscountHandler,
		newOrderServiceUpdateOrderDiscountArgs,
		newOrderServiceUpdateOrderDiscountResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"GetSalesReport": kitex.NewMethodInfo(
		getSalesReportHandler,
		newOrderServiceGetSalesReportArgs,
		newOrderServiceGetSalesReportResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
}
...
func updateOrderTrackingHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*order.OrderServiceUpdateOrderTrackingArgs)
	realResult := result.(*order.OrderServiceUpdateOrderTrackingResult)
	success, err := handler.(order.OrderService).UpdateOrderTracking(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newOrderServiceUpdateOrderTrackingArgs() interface{} {
	return order.NewOrderServiceUpdateOrderTrackingArgs()
}

func newOrderServiceUpdateOrderTrackingResult() interface{} {
	return order.NewOrderServiceUpdateOrderTrackingResult()
}

func updateOrderDiscountHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*order.OrderServiceUpdateOrderDiscountArgs)
	realResult := result.(*order.OrderServiceUpdateOrderDiscountResult)
	success, err := handler.(order.OrderService).UpdateOrderDiscount(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newOrderServiceUpdateOrderDiscountArgs() interface{} {
	return order.NewOrderServiceUpdateOrderDiscountArgs()
}

func newOrderServiceUpdateOrderDiscountResult() interface{} {
	return order.NewOrderServiceUpdateOrderDiscountResult()
}

func getSalesReportHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*order.OrderServiceGetSalesReportArgs)
	realResult := result.(*order.OrderServiceGetSalesReportResult)
	success, err := handler.(order.OrderService).GetSalesReport(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newOrderServiceGetSalesReportArgs() interface{} {
	return order.NewOrderServiceGetSalesReportArgs()
}

func newOrderServiceGetSalesReportResult() interface{} {
...
func (p *kClient) UpdateOrderTracking(ctx context.Context, req *order.UpdateOrderTrackingReq) (r *order.UpdateOrderTrackingResp, err error) {
	var _args order.OrderServiceUpdateOrderTrackingArgs
	_args.Req = req
	var _result order.OrderServiceUpdateOrderTrackingResult
	if err = p.c.Call(ctx, "UpdateOrderTracking", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) UpdateOrderDiscount(ctx context.Context, req *order.UpdateOrderDiscountReq) (r *order.UpdateOrderDiscountResp, err error) {
	var _args order.OrderServiceUpdateOrderDiscountArgs
	_args.Req = req
	var _result order.OrderServiceUpdateOrderDiscountResult
	if err = p.c.Call(ctx, "UpdateOrderDiscount", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) GetSalesReport(ctx context.Context, req *order.SalesReportReq) (r *order.SalesReportResp, err error) {
	var _args order.OrderServiceGetSalesReportArgs
	_args.Req = req
