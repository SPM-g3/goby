...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"createProductReview": kitex.NewMethodInfo(
		createProductReviewHandler,
		newProductServiceCreateProductReviewArgs,
		newProductServiceCreateProductReviewResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"GetProductReviews": kitex.NewMethodInfo(
		getProductReviewsHandler,
		newProductServiceGetProductReviewsArgs,
		newProductServiceGetProductReviewsResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"CreatePromotion": kitex.NewMethodInfo(
		createPromotionHandler,
		newProductServiceCreatePromotionArgs,
		newProductServiceCreatePromotionResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"GetActivePromotions": kitex.NewMethodInfo(
		getActivePromotionsHandler,
		newProductServiceGetActivePromotionsArgs,
		newProductServiceGetActivePromotionsResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
	"DeletePromotion": kitex.NewMethodInfo(
		deletePromotionHandler,
		newProductServiceDeletePromotionArgs,
		newProductServiceDeletePromotionResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
...
func listProductHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	_ = arg.(*product.ProductServiceListProductArgs)
	realResult := result.(*product.ProductServiceListProductResult)
	success, err := handler.(product.ProductService).ListProduct(ctx)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func createProductReviewHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*product.ProductServiceCreateProductReviewArgs)
	realResult := result.(*product.ProductServiceCreateProductReviewResult)
	success, err := handler.(product.ProductService).CreateProductReview(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newProductServiceCreateProductReviewArgs() interface{} {
	return product.NewProductServiceCreateProductReviewArgs()
}

func newProductServiceCreateProductReviewResult() interface{} {
	return product.NewProductServiceCreateProductReviewResult()
}

func getProductReviewsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*product.ProductServiceGetProductReviewsArgs)
	realResult := result.(*product.ProductServiceGetProductReviewsResult)
	success, err := handler.(product.ProductService).GetProductReviews(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newProductServiceGetProductReviewsArgs() interface{} {
	return product.NewProductServiceGetProductReviewsArgs()
}

func newProductServiceGetProductReviewsResult() interface{} {
	return product.NewProductServiceGetProductReviewsResult()
}

func createPromotionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*product.ProductServiceCreatePromotionArgs)
	realResult := result.(*product.ProductServiceCreatePromotionResult)
	success, err := handler.(product.ProductService).CreatePromotion(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newProductServiceCreatePromotionArgs() interface{} {
	return product.NewProductServiceCreatePromotionArgs()
}

func newProductServiceCreatePromotionResult() interface{} {
	return product.NewProductServiceCreatePromotionResult()
}

func getActivePromotionsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	_ = arg.(*product.ProductServiceGetActivePromotionsArgs)
	realResult := result.(*product.ProductServiceGetActivePromotionsResult)
	success, err := handler.(product.ProductService).GetActivePromotions(ctx)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newProductServiceGetActivePromotionsArgs() interface{} {
	return product.NewProductServiceGetActivePromotionsArgs()
}

func newProductServiceGetActivePromotionsResult() interface{} {
	return product.NewProductServiceGetActivePromotionsResult()
}

func deletePromotionHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*product.ProductServiceDeletePromotionArgs)
	realResult := result.(*product.ProductServiceDeletePromotionResult)
	success, err := handler.(product.ProductService).DeletePromotion(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newProductServiceDeletePromotionArgs() interface{} {
	return product.NewProductServiceDeletePromotionArgs()
}

func newProductServiceDeletePromotionResult() interface{} {
...
func (p *kClient) ListProduct(ctx context.Context) (r *product.ListProductResp, err error) {
...
func (p *kClient) CreateProductReview(ctx context.Context, req *product.CreateProductReviewReq) (r *product.CreateProductReviewResp, err error) {
	var _args product.ProductServiceCreateProductReviewArgs
	_args.Req = req
	var _result product.ProductServiceCreateProductReviewResult
	if err = p.c.Call(ctx, "createProductReview", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) GetProductReviews(ctx context.Context, req *product.GetProductReviewsReq) (r *product.GetProductReviewsResp, err error) {
	var _args product.ProductServiceGetProductReviewsArgs
	_args.Req = req
	var _result product.ProductServiceGetProductReviewsResult
	if err = p.c.Call(ctx, "GetProductReviews", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) CreatePromotion(ctx context.Context, req *product.CreatePromotionReq) (r *product.CreatePromotionResp, err error) {
	var _args product.ProductServiceCreatePromotionArgs
	_args.Req = req
	var _result product.ProductServiceCreatePromotionResult
	if err = p.c.Call(ctx, "CreatePromotion", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) GetActivePromotions(ctx context.Context) (r *product.GetActivePromotionsResp, err error) {
	var _args product.ProductServiceGetActivePromotionsArgs
	var _result product.ProductServiceGetActivePromotionsResult
	if err = p.c.Call(ctx, "GetActivePromotions", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) DeletePromotion(ctx context.Context, req *product.DeletePromotionReq) (r *product.DeletePromotionResp, err error) {
	var _args product.ProductServiceDeletePromotionArgs
	_args.Req = req
